...
@Test func testMovieResponseInitialization() async throws {
    // Given
    let movies = [
        Movie(id: 1, title: "Test Movie 1", overview: "Test Overview 1", releaseDate: "2023-01-01", posterPath: "/test1.jpg"),
        Movie(id: 2, title: "Test Movie 2", overview: "Test Overview 2", releaseDate: "2023-01-02", posterPath: "/test2.jpg")
    ]
